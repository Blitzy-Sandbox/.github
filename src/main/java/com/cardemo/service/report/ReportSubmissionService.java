 ...
 */
@Service
public class ReportSubmissionService implements ReportService {
    ...
    private void sendToSqs(String reportName, LocalDate startDate, LocalDate endDate) {
        ...
        messagePayload.put("startDate", startDate.format(DateFormatConstants.ISO_DATE_FORMATTER));
        messagePayload.put("endDate", endDate.format(DateFormatConstants.ISO_DATE_FORMATTER));
    ...
    private void validateCustomDates(ReportRequest request) {
        ...
        String startDateStr = startDate.format(DateFormatConstants.ISO_DATE_FORMATTER);
        ...
        String endDateStr = endDate.format(DateFormatConstants.ISO_DATE_FORMATTER);
