 ...
 */
@Service
public class UserDeleteService implements AdminService {
    ...
    // contract but are NOT part of the {@code UserDeleteService} domain. Per
    ...
    // {@code com.cardemo.service.admin.UserListService} and
    ...
    //
    // See: UserListService (same-pattern implementation in admin domain),
    ...
    /**
     * Interface-contract stub. {@code UserDeleteService} does not create users —
    ...
    public UserSecurityDto addUser(UserSecurityDto dto) {
        throw new UnsupportedOperationException(
                "UserDeleteService does not create users; use UserAddService.addUser(UserSecurityDto)");
    }

    /**
     * Interface-contract stub. {@code UserDeleteService} does not list users —
    ...
    public Page<UserSecurityDto> listUsers(int pageNumber) {
        throw new UnsupportedOperationException(
                "UserDeleteService does not list users; use UserListService.listUsers(int)");
    }
    ...
    public Page<UserSecurityDto> listUsersFromId(String startUserId, int pageNumber) {
        throw new UnsupportedOperationException(
                "UserDeleteService does not list users; "
                        + "use UserListService.listUsersFromId(String, int)");
    }

    /**
     * Interface-contract stub. {@code UserDeleteService} does not evaluate
    ...
    public boolean hasNextPage(Page<?> page) {
        throw new UnsupportedOperationException(
                "UserDeleteService does not evaluate pagination; use UserListService.hasNextPage(Page)");
    }
    ...
    public boolean hasPreviousPage(Page<?> page) {
        throw new UnsupportedOperationException(
                "UserDeleteService does not evaluate pagination; use UserListService.hasPreviousPage(Page)");
    }

    /**
     * Interface-contract stub. {@code UserDeleteService} does not prepare update
     * views — see
    ...
    public UserSecurityDto getUserForUpdate(String userId) {
        throw new UnsupportedOperationException(
                "UserDeleteService does not prepare update views; "
                        + "use UserUpdateService.getUserForUpdate(String)");
    }

    /**
     * Interface-contract stub. {@code UserDeleteService} does not update users —
     * see
    ...
    public UserSecurityDto updateUser(String userId, UserSecurityDto dto) {
        throw new UnsupportedOperationException(
                "UserDeleteService does not update users; "
