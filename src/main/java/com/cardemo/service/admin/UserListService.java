...
public class UserListService implements AdminService {
    ...
    public Page<UserSecurityDto> listUsers(int pageNumber) {
        ...
        Pageable pageable = PageRequest.of(safePage, PaginationConstants.USER_PAGE_SIZE, Sort.by("secUsrId").ascending());
    ...
    // =====================================================================
    //
    // The following five methods satisfy the {@link AdminService} interface
    // contract but are NOT part of the {@code UserListService} domain. Per the
    // interface's class-level Javadoc:
    //
    ...
    // {@code com.cardemo.service.menu.MainMenuService}, which provides
    // equivalent stubs for admin-menu operations owned by
    // {@code AdminMenuService}.
    //
    // See: MainMenuService (reference implementation pattern),
    //      AAP Section 0.5.1 (Updated Service Files — interface introduction),
    //      AdminService Javadoc lines 55-66 (implementation strategy).

    /**
     * Interface-contract stub. {@code UserListService} does not create users —
    ...
    public UserSecurityDto addUser(UserSecurityDto dto) {
        throw new UnsupportedOperationException(
                "UserListService does not create users; use UserAddService.addUser(UserSecurityDto)");
    }

    /**
     * Interface-contract stub. {@code UserListService} does not prepare delete
     * views — see
    ...
    public UserSecurityDto getUserForDelete(String userId) {
        throw new UnsupportedOperationException(
                "UserListService does not prepare delete views; "
                        + "use UserDeleteService.getUserForDelete(String)");
    }

    /**
     * Interface-contract stub. {@code UserListService} does not delete users —
    ...
    public UserSecurityDto deleteUser(String userId) {
        throw new UnsupportedOperationException(
                "UserListService does not delete users; use UserDeleteService.deleteUser(String)");
    }

    /**
     * Interface-contract stub. {@code UserListService} does not prepare update
     * views — see
    ...
    public UserSecurityDto getUserForUpdate(String userId) {
        throw new UnsupportedOperationException(
                "UserListService does not prepare update views; "
                        + "use UserUpdateService.getUserForUpdate(String)");
    }

    /**
     * Interface-contract stub. {@code UserListService} does not update users —
     * see
    ...
    public UserSecurityDto updateUser(String userId, UserSecurityDto dto) {
        throw new UnsupportedOperationException(
                "UserListService does not update users; "
