 ...
 * It delegates the entire atomic payment cycle to {@link BillingService},
 ...
 *       <td>{@link BillingService#processPayment(String)} — account lookup</td></tr>
 *   <tr><td>READ-CXACAIX-FILE</td><td>408-436</td>
 *       <td>{@link BillingService#processPayment(String)} — cross-reference resolution</td></tr>
 *   <tr><td>STARTBR-TRANSACT-FILE</td><td>441-467</td>
 *       <td>{@link BillingService#processPayment(String)} — auto-ID generation (start browse)</td></tr>
 *   <tr><td>READPREV-TRANSACT-FILE</td><td>472-496</td>
 *       <td>{@link BillingService#processPayment(String)} — auto-ID generation (read previous)</td></tr>
 *   <tr><td>ENDBR-TRANSACT-FILE</td><td>501-505</td>
 *       <td>{@link BillingService#processPayment(String)} — end browse</td></tr>
 *   <tr><td>WRITE-TRANSACT-FILE</td><td>510-547</td>
 *       <td>{@link BillingService#processPayment(String)} — transaction write</td></tr>
 *   <tr><td>UPDATE-ACCTDAT-FILE</td><td>377-403</td>
 *       <td>{@link BillingService#processPayment(String)} — account balance update</td></tr>
...
public class BillingController {
    ...
    /**
     * Bill payment service contract implementing the full atomic payment cycle.
     * Spring injects the concrete implementation from {@code com.cardemo.service.billing}
     * at runtime; the controller depends only on the interface.
     *
     * <p>Migrated from COBIL00C.cbl (572 lines), performs account lookup, balance
     ...
     * annotation per Spring best practices).</p>
     */
    private final BillingService billingService;

    /**
     * Constructs a new BillingController with the required BillingService dependency.
     *
     ...
     *
     * @param billingService the service contract handling the full atomic bill payment
     *                       cycle including account lookup, balance validation,
     ...
     * <p>The {@link BillingService#processPayment(String)} method performs
    ...
    public ResponseEntity<?> payBill(@Valid @RequestBody BillPaymentRequest request) {
        ...
        // Delegate to BillingService for the complete atomic payment cycle.
        ...
        var result = billingService.processPayment(request.getAccountId());
