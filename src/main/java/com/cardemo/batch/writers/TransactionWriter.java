...
public class TransactionWriter implements ItemWriter<Transaction> {
    ...
    private void postSingleTransaction(Transaction transaction) {
        ...
        log.debug("Posted transaction {}: card={}, acct={}, amt={}, "
                ...
                typeCd, catCd, origTs,
                procTs.format(DateFormatConstants.DB2_TIMESTAMP_FORMATTER));
    }
    ...
    private void writeS3Backup(List<? extends Transaction> transactions,
                                long chunkIndex) {
        try {
            String timestamp = LocalDateTime.now().format(DateFormatConstants.BACKUP_TIMESTAMP_FORMATTER);
    ...
    private String formatTransactionForBackup(Transaction transaction) {
        return String.join("|",
                ...
                transaction.getTranProcTs() != null
                        ? transaction.getTranProcTs().format(DateFormatConstants.DB2_TIMESTAMP_FORMATTER)
                        : ""
        );
    }
